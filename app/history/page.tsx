...
import { ArrowLeft, Calendar, TrendingUp, Flame, Activity, Zap, Beef, Wheat, Droplet } from "lucide-react";
...
export default function HistoryPage() {
  ...
  const loadData = async () => {
    ...
    if (mealsRes.success) {
      setMeals(mealsRes.meals as any);
    }
        ...
        <div className="space-y-4">
          {meals.length === 0 ? (
            <div className="bg-white rounded-xl shadow-lg p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">No meals logged yet</h3>
              <p className="text-gray-600 mb-6">Start scanning your meals to track your nutrition!</p>
              <Link 
                href="/"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-500 text-sm">{formatDate(meal.createdAt)}</span>
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold text-gray-800">{meal.totalCalories}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="bg-red-50 p-3 rounded-lg text-center">
                      ...
                      <p className="text-lg font-bold text-red-700">{meal.totalProtein}g</p>
                    ...
                    <div className="bg-orange-50 p-3 rounded-lg text-center">
                      ...
                      <p className="text-lg font-bold text-orange-700">{meal.totalCarbs}g</p>
                    ...
                    <div className="bg-yellow-50 p-3 rounded-lg text-center">
                      ...
                      <p className="text-lg font-bold text-yellow-700">{meal.totalFats}g</p>
                      ...
                      {meal.foods.map((food) => (
                        ...
                        >
                          <div>
                            ...
                            <span className="text-gray-500 ml-2">({food.portionSize})</span>
                          </div>
                          <span className="text-gray-600 font-semibold">{food.calories} cal</span>
                        </div>
                      ))}
                    </div>
                  </div>
